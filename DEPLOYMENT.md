...
- ✅ **Jekyll disabled** (`.nojekyll` file in public directory)
...
**Main URL:**
```
https://<your-github-username>.github.io/ZuoGuoHuaDiao/
```

This will load the main application using HashRouter for client-side routing.
...
export default defineConfig({
  base: '/ZuoGuoHuaDiao/', // Matches your GitHub repo name
  build: {
...
This ensures all assets are loaded with the correct base path when deployed to GitHub Pages.
...
├── robots.txt
├── sitemap.xml
└── .nojekyll           # Disables Jekyll processing (from public/)
```
...
```js
// Remove or comment out base for custom domain
// base: '/ZuoGuoHuaDiao',

// Or set to root
base: '/',  // Would be: example.com/
```
...
5. Users access at: `https://<username>.github.io/ZuoGuoHuaDiao/`
